...
If you find a security vulnerability in API Gateway, please report it through [GitHub's private vulnerability reporting](https://github.com/franckngaks/api_gateway/security/advisories/new). This keeps the details private while we work on a fix.
