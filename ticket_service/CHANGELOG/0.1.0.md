...
```sh
uv add ticket_service
```

### What's in the scaffold

- `src/ticket_service/` package with CLI (Typer + Rich), py.typed marker
...
[@franckngaks](https://github.com/franckngaks) (Franck Ngako) created Ticket Service.
