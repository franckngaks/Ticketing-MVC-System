...
If you find a security vulnerability in Incident Service, please report it through [GitHub's private vulnerability reporting](https://github.com/franckngaks/identite_service/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact franckngako.dev@proton.me for details.
