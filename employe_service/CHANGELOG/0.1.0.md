...
```sh
uv add identite_service
```

### What's in the scaffold

- `src/identite_service/` package with CLI (Typer + Rich), py.typed marker
...
[@franckngaks](https://github.com/franckngaks) (Franck Ngako) created Incident Service.
